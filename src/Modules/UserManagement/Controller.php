...
class Controller extends BaseController
{
  public function __construct($config)
  {
    ...
    $this->addRoute('/create', function() {
      return $this->view('pages/create.twig');
    });

    $this->addRoute('/create', function($request) {
    ...
    $this->addRoute('/delete', function($request) {
    ...
    $this->addRoute('/clear-session', function($request) {
    ...
    $this->addRoute('/update-password', function($request) {
